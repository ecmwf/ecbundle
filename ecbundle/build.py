...
clean_sh = string.Template("""#!/usr/bin/env bash
...
configure_sh = string.Template("""#!/usr/bin/env bash
...
build_sh = string.Template("""#!/usr/bin/env bash
...
install_sh = string.Template("""#!/usr/bin/env bash
